...
namespace Qatual
{
    public class Settings
    {
        ...
        // Dark teal theme — #1f3434 bg, #111d1d button off, #223d3d button on
        public static ExtGradient backgroundColor = new ExtGradient { colors = ExtGradient.GetSolidGradient(new Color32(31, 52, 52, 255)) };
        public static ExtGradient[] buttonColors = new ExtGradient[]
        {
            new ExtGradient { colors = ExtGradient.GetSolidGradient(new Color32(17, 29, 29, 255)) }, // Disabled — #111d1d
            new ExtGradient { colors = ExtGradient.GetSolidGradient(new Color32(34, 61, 61, 255)) }  // Enabled  — #223d3d
        };
        public static Color[] textColors = new Color[]
        {
            new Color32(190, 216, 216, 255), // Disabled — #bed8d8 muted teal-white
            Color.white                      // Enabled
        };
